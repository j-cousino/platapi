...
export function createShader(gl: WebGL2RenderingContext, type: GLenum, source: string) {
    ...
    if( !shader ) throw("Could not create a shader!");
    ...
    throw("Could not compile the shader!");
  }
...
export function createProgram(
    ...
    if( !program ) throw("Could not create a shader!");
    ...
    throw("Could not link the shaders into a program!");
}
